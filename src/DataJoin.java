...
public class DataJoin {
	...
	// 定义输入路径
	private static final String INPUT_PATH = "batch/input";
	// 定义输出路径
	private static final String OUT_PATH = "batch/output";
	...
	private static class MyOut extends TextOutputFormat{
		  protected static void setOutputName(JobContext job, String name) {
			    job.getConfiguration().set(OUT_PATH, name);
		  }
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			MyOut.setOutputName(job, "result");
